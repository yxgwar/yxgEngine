...
BlinnPhong::BlinnPhong(std::shared_ptr<Model> model)
    :ModelTest("BlinnPhong")
{
    m_model = model;

    SetDefaultShaderFromFile("../assets/shaders/BlinnPhong/model.vs", "../assets/shaders/BlinnPhong/model.fs");
